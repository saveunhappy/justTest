...
public class CopyDataPrepared {
    public static final String CATALOG = "E:/copy/dataStructure/homework/";
    public static final String SNO_PREFIX = "20200123";
    public static final String CLASS_PREFIX = "z计科203";
    public static final String DATE = "11月12日";
...
//        list.add("01");list.add("02");list.add("03");list.add("04");list.add("05");list.add("06");
//        list.add("07");list.add("08");list.add("09");list.add("10");list.add("11");list.add("12");
//        list.add("13");list.add("15");list.add("16");list.add("17");list.add("18");list.add("19");
//        list.add("20");list.add("21");list.add("22");list.add("23");list.add("24");list.add("25");
//        list.add("26");list.add("27");list.add("28");
    ...
    public static void main(String[] args) {
        CopyDataPrepared copyDataPrepared  = new CopyDataPrepared();
        List<String> allNo = copyDataPrepared.getAllNo();
        for (int i = 0; i < allNo.size(); i++) {
            System.out.println(allNo.get(i));
        }
    }
}
